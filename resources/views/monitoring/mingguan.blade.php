...
@section('title', 'Monitoring Mingguan BBM')
...
<div class="d-flex justify-content-between align-items-start mb-4">
    ...
    <div>
        ...
        <h1 class="mb-2">
            Monitoring Mingguan BBM
        </h1>

        <p class="text-muted mb-0">
            Ringkasan penggunaan BBM pada minggu berjalan.
        </p>

    </div>

    <a
        href="{{ route('monitoring.mingguan.pdf', [
            'tanggal_mulai' => $awalMinggu->format('Y-m-d'),
            ...
            <div class="row g-3 align-items-start">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <input
                        ...
                        id="tanggal_mulai"
                        class="form-control"
                        value="{{ $awalMinggu->format('Y-m-d') }}"
                    >

                    <div class="form-text">
                        Pilih salah satu tanggal untuk menentukan minggu monitoring.
                    </div>
                            ...
                            <optgroup label="Kendaraan Operasional">
                                ...
                                @foreach ($kendaraanOperasional as $item)
                                    ...
                                    <option
                                        ...
                                        {{ $kendaraanFilter === $item->kode_unit ? 'selected' : '' }}
                                    >
                                        {{ $item->kode_unit }}
                        ...
                        @if ($kendaraanGs->count())
                            ...
                            <optgroup label="Kendaraan GS">
                                ...
                                @foreach ($kendaraanGs as $item)
                                    ...
                                    <option
                                        value="{{ $item->kode_gs }}"
                                        {{ $kendaraanFilter === $item->kode_gs ? 'selected' : '' }}
                                    >
                                        {{ $item->kode_gs }}
                                    </option>
    ...
    <div class="card-body p-0">
        ...
        <div class="d-flex justify-content-between align-items-center px-4 py-3 border-bottom">
            ...
            <div>
                ...
                <h5 class="mb-1">
                    Penggunaan dan Efisiensi Berdasarkan Kendaraan
                </h5>

                <p class="text-muted mb-0 small">
                    Perbandingan penggunaan BBM dan efisiensi konsumsi setiap kendaraan.
                </p>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($data['km_sebelumnya'] !== null)
                                    {{ number_format((float) $data['km_sebelumnya'], 0, ',', '.') }} km
                                @else
                                    -
                                @endif
                            </td>
                            ...
                            <td>
                                {{ number_format((float) $data['km_sekarang'], 0, ',', '.') }} km
                            </td>

                            <td>
                                @if ($data['total_jarak'] !== null)
                                    {{ number_format((float) $data['total_jarak'], 0, ',', '.') }} km
                                @else
                                    -
                                @endif
                            </td>
                            ...
                            <td>
                                @if ($data['rasio_aktual'] !== null)
                                    {{ number_format((float) $data['rasio_aktual'], 2, ',', '.') }} km/L
                                @else
                                    -
                                @endif
                            </td>
                            ...
                            <td>
                                @if ($data['rasio_standar'] !== null)
                                    {{ number_format((float) $data['rasio_standar'], 2, ',', '.') }} km/L
                                @else
                                    -
                                @endif
                            </td>
                            ...
                            <td class="{{ ($data['varian_pemborosan'] ?? 0) > 0 ? 'text-danger fw-semibold' : '' }}">

                                {{ number_format((float) ($data['varian_pemborosan'] ?? 0), 2, ',', '.') }} L

                            </td>

                            <td class="{{ ($data['biaya_kerugian'] ?? 0) > 0 ? 'text-danger fw-semibold' : '' }}">

                                Rp {{ number_format((float) ($data['biaya_kerugian'] ?? 0), 0, ',', '.') }}
            ...
            <div class="card-body p-0">
                ...
                <div class="d-flex justify-content-between align-items-center px-4 py-3 border-bottom">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0 small">
                            Ringkasan penggunaan BBM setiap cost center.
                        </p>
    ...
    <div class="card-body p-0">
        ...
        <div class="d-flex justify-content-between align-items-center px-4 py-3 border-bottom">
            ...
            <div>
                ...
                <p class="text-muted mb-0 small">
                    Ringkasan penggunaan berdasarkan jenis BBM.
                </p>

            </div>

            <span class="badge bg-light text-dark border">
                {{ count($perBbm) }} Jenis BBM
            </span>
    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                ...
                <p class="text-muted mb-0 small">
                    Ringkasan analisis penggunaan BBM berdasarkan data monitoring.
                </p>
    ...
    <div class="card-body p-0">
        ...
        <div class="d-flex justify-content-between align-items-center px-4 py-3 border-bottom">
            ...
            <div>
                ...
                <p class="text-muted mb-0 small">
                    Daftar transaksi pengisian BBM pada periode dan filter yang dipilih.
                </p>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif ($item->kendaraanGs)
                                    ...
                                    {{ $item->kendaraanGs->jenis_kendaraan ?? '-' }}
                            ...
                            <td>
                                {{ number_format((float) $item->kilometer, 0, ',', '.') }} km
                            </td>
